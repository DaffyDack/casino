export default {
  root: ({ props, state }) => ({
    class: [
      ...
      // States
      {
        'ring-1 ring-inset ring-surface-300 dark:ring-surface-600':
          !state.focused,
        'ring-1 ring-inset ring-primary-500 dark:ring-primary-400':
          state.focused,
      },
  ...
  headerCheckbox: {
    ...
    box: ({ props, context }) => ({
      class: [
        ...
        'text-surface-600',
        {
          'border-surface-300 bg-surface-0 dark:border-surface-700 dark:bg-surface-850':
            !context.checked,
          'border-primary-500 bg-primary-500 dark:border-primary-400 dark:bg-primary-400':
            context.checked,
        },
